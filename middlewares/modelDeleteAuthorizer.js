...
/**
 * The middleware to authorize DELETE requests
 * @param  {object}   model     The requesting model object
 * @param  {string}   urlParam  The DELETE request URL parameter
 ...
 */
const modelDeleteAuthorizer = (model, urlParam, req, res, next) => {
  const user = req.user;
...
module.exports = modelDeleteAuthorizer;
